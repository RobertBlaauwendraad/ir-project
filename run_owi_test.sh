...
#SBATCH --mem=15G
#SBATCH --time=4:00:00
#SBATCH --output=logs/owi_exp_%j.out
#SBATCH --error=logs/owi_exp_%j.err
...
echo "=============================================="
echo "IR Project - SPLADE baseline experiment OWI"
echo "=============================================="
...
echo "=============================================="
echo "OWI SPLADE baseline experiment completed!"
echo "=============================================="
